...
> = {
  ADMIN:  { password: "ADMIN0001",   user: { id: "ADMIN",  name: "Administrador",  role: "admin",   shift: "Mañana" } },
  TURNO1: { password: "TURNO12025",  user: { id: "TURNO1", name: "Cajero Turno 1", role: "cashier", shift: "Mañana" } },
